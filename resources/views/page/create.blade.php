...
@section('content')
    <div class="container pb-5">
        <form class="needs-validation" novalidate method="POST" action="{{ route('page.store') }}"
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    ...
                    <textarea id="apropos" class="form-control editor @error('apropos') is-invalid @enderror" name="apropos" required>{{ old('apropos') }}</textarea>
            ...
            <div class="row mb-3">
                <div class="col-md-12 form-group">
                    ...
                    <textarea id="but" class="form-control editor @error('but') is-invalid @enderror" name="but" required>{{ old('but') }}</textarea>
                    <div class="invalid-feedback">
                        {{ __('formulaire.Obligation') }}
                    </div>
                    @error('but')
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    ...
                    <textarea id="objectif" class="form-control editor @error('objectif') is-invalid @enderror" name="objectif" required>{{ old('objectif') }}</textarea>
                    <div class="invalid-feedback">
                        {{ __('formulaire.Obligation') }}
                    </div>
                    @error('objectif')
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    ...
                    <textarea id="contenu" class="form-control editor @error('contenu') is-invalid @enderror" name="contenu" required>{{ old('contenu') }}</textarea>
                    <div class="invalid-feedback">
                        {{ __('formulaire.Obligation') }}
                    </div>
                    @error('contenu')
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    ...
                    <textarea id="guide" class="form-control editor @error('guide') is-invalid @enderror" name="guide" required>{{ old('guide') }}</textarea>
                    <div class="invalid-feedback">
                        {{ __('formulaire.Obligation') }}
                    </div>
                    @error('guide')
            ...
            <div class="row mb-3">
                <div class="form-group col-12">
                    ...
                    <div id="communautesDropzone" class="dropzone d-flex justify-content-center"></div>
                </div>
            </div>
