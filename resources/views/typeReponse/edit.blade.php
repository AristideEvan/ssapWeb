...
<div class="container-fluid" >
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header py-0">{{ __('Modifier typeReponse') }}</div>
                    <div class="card-body">
                        <form class="needs-validation" novalidate method="POST" action="{{ route('typeReponse.update',$typeReponse->typeReponse_id) }}">
                            @csrf
                            @method('PUT')
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    value="{{ $typeReponse->typeReponseLibelle }}" required autocomplete="typeReponse" autofocus onkeyup="this.value = this.value.toUpperCase();">
