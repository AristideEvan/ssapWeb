...
<div class="row justify-content-center">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header py-0">{{ __('Ajouter un sol') }}</div>
                <div class="card-body">
                    <form class="needs-validation" novalidate method="POST" action="{{ route('sol.store') }}">
                        @csrf
                        <div class="row">
                            <div class="col-md-8 offset-md-2">
                                <fieldset>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="solLibelle" id="solLibelle" class="form-control @error('solLibelle') is-invalid @enderror" required>
