...
<div class="container-fluid" >
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header py-0">{{ __('Ajouter type de Beneficiaire') }}</div>
                    <div class="card-body">
                        <form class="needs-validation" novalidate method="POST" action="{{ route('typeBeneficiaire.store') }}">
                            @csrf
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    value="{{ old('typeBeneficiaire') }}" required autofocus onkeyup="this.value = this.value.toUpperCase();">
