            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="needs-validation" novalidate method="POST"
                        action="{{ route('pratique.section.update', ['id' => $pratique->pratique_id, 'section' => $section, 'rub' => $rub, 'srub' => $srub]) }}"
                            ...
                            <div class="row" id="section-1">
                                <div class="col-md-12">
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <label for="objectif"> {{ __('Objectif') }} <span
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <input class="form-control  @error('cout') is-invalid @enderror"
                                                    type="number" step="100000" min="0" name="cout"
                                                    id="cout" required value="{{ old('cout', $pratique->cout) }}">
                                                <div class="invalid-feedback">
                                                    {{ __('formulaire.Obligation') }}
                                                </div>
                                                @error('cout')
                                            ...
                                            {{-- <div class="col-md-4">
                                                <label for="conseil"> {{ __('Conseils') }} <span
                                                        style="color: red">*</span>
                                                </label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <label
                                                    for="description_env_humain">{{ __('Partenariats') }}
                                            ...
                                            <div class="col-md-4">
                                                <label for="recommandation"> {{ __('Leçons tirées') }}
                                                    <span style="color: red">*</span> </label>
                        ...
                        @if ($section == 2)
                            <div class="row" id="section-2">
                                <div class="col-md-12">
                                    <fieldset class="mt-3">
                                        <legend>I{{ __('nformations suplémentaires') }} </legend>
                                         <div class="row">
                                            <div class="col-md-6">
                                                <label for="climat"> {{ __('Climat') }} <span
                                                        style="color: red">*</span> </label>
                                                <select id="climat"
                                            ...
                                            <div class="col-md-6">
                                                <label for="sol"> {{ __('Sol') }} <span
                                                        style="color: red">*</span> </label>
                                                <select id="sol"
                                                    class="form-control @error('sol') is-invalid @enderror"
                                                    name="sol[]" multiple autofocus>
                                                    <option value=""></option>
                        ...
                        @if ($section == 5)
                            <div id="section-5">
                                <fieldset>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label for="partenaire"> {{ __('Partenaires') }}
                                            </label>
                                        ...
                                        <div class="col-md-6">
                                            <label for="beneficiaire"> {{ __('Bénéficiaires') }}
                                            </label>
                                                ...
                                                <div class="zone-container">
                                                    <div class="row">
                                                        <div class="col-12 col-md-6">
                                                            <label
                                                                for="pays{{ $loop->iteration }}">{{ __('Pays') }}</label>
                                                            ...
                                                            <select name="zones[{{ $loop->iteration }}][pays]"
                                                                id="pays{{ $loop->iteration }}"
                                                                class="form-control pays">
                                                                <option value="">
                                                                    {{ __('Sélectionnez une localité') }}
                                                                </option>
                        ...
                        @if ($section == 4)
                            <div id="section-4">
                                <fieldset class="mt-3">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="images-vedette">{{ __('Image vedette') }}<span style="color: red">*</span></label>
                                            ...
                                            <input type="file" name="image_vedette" id="hidden-vedette"
                                                style="display: none">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <input type="file" name="images[]" id="hidden-images" style="display: none"
                                        multiple>
                                    <input type="hidden" name="removed_images[]" id="removed-images">

                                    <div class="form-group">
                                        <label for="documents">{{ __('Documents') }}<span style="color: red">*</span></label>
                                        <div class="dropzone d-flex justify-content-center justify-content-md-left flex-wrap"
                                    ...
                                    <input type="file" name="documents[]" id="hidden-documents" style="display: none"
                                        multiple>
                                    <input type="hidden" name="removed_documents[]" id="removed-documents">
    ...
    @push('scripts')
        <script>
            $(document).ready(function() {
                ...
                var section = <?php echo $section ?? 0; ?>;
                if (section == 4) {
