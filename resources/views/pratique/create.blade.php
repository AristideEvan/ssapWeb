    ...
    <div class="row justify-content-center" style="max-width: 100%">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="needs-validation" novalidate method="POST" action="{{ route('pratique.store') }}"
                        enctype="multipart/form-data" id="form-pratique">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <fieldset>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label for="objectif"> Objectif <span style="color: red">*</span> </label>
                                    ...
                                    <div class="row">
                                            ...
                                            {{-- <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <input
                                                        ...
                                                        value="{{ old('periodeDebut') }}" placeholder="JJ-MM-AAAA">
                                                    <div class="invalid-feedback">
                                                        {{ __('formulaire.Obligation') }}
                                                    </div>
                                                    @error('periodeDebut')
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <input
                                                        ...
                                                        value="{{ old('periodeFin') }}" placeholder="JJ-MM-AAAA">
                                                    <div class="invalid-feedback">
                                                        {{ __('formulaire.Obligation') }}
                                                    </div>
                                                    @error('periodeFin')
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <textarea class="form-control @error('avantage') is-invalid @enderror" type="text" name="avantage" id="avantage"
                                                required>{{ old('avantage') }}</textarea>
                                            <div class="invalid-feedback">
                                                {{ __('formulaire.Obligation') }}
                                            </div>
                                            @error('avantage')
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <textarea class="form-control @error('contrainte') is-invalid @enderror" type="text" name="contrainte"
                                                id="contrainte" required>{{ old('contrainte') }}</textarea>
                                            <div class="invalid-feedback">
                                                {{ __('formulaire.Obligation') }}
                                            </div>
                                            @error('contrainte')
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <label for="description_env_humain">
                                                {{ __('Partenariats') }}
                                                <span style="color: red">*</span> </label>
                                            <textarea class="form-control  @error('cout') is-invalid @enderror" type="text" name="description_env_humain"
                                                id="description_env_humain" required>{{ old('description_env_humain') }}</textarea>
                                            <div class="invalid-feedback">
                                                {{ __('formulaire.Obligation') }}
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <label for="recommendation"> {{ __('Leçons tirées') }} <span
                                                    style="color: red">*</span> </label>
                                            <textarea class="form-control @error('recommendation') is-invalid @enderror" type="text" name="recommandation"
                                                id="recommandation" required>{{ old('recommandation') }}</textarea>
                                            <div class="invalid-feedback">
                                                {{ __('formulaire.Obligation') }}
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <fieldset class="mt-3">
                                    <legend>{{ __('Informations spécifiques') }} </legend>
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <select id="climat"
                                                ...
                                                @foreach ($climats as $climat)
                                                    <option value="{{ $climat->climat_id }}"
                                                        {{ in_array($climat->climat_id, old('climat') ?? []) ? 'selected' : '' }}>
                                                        {{ $climat->libelleClimat }}</option>
                                                @endforeach
                                            </select>
                                            <div class="invalid-feedback">
                                                {{ __('formulaire.Obligation') }}
                                            ...
                                            <select id="sol"
                                                ...
                                                @foreach ($sols as $sol)
                                                    <option value="{{ $sol->sol_id }}"
                                                        {{ in_array($sol->sol_id, old('sol') ?? []) ? 'selected' : '' }}>
                                                        {{ $sol->solLibelle }}</option>
                                                @endforeach
                                            </select>
                                            <div class="invalid-feedback">
                                                {{ __('formulaire.Obligation') }}
                                    ...
                                    <div class="row">
                                            ...
                                            <select id="pilier"
                                                ...
                                                @foreach ($piliers as $pilier)
                                                    <option value="{{ $pilier->pilier_id }}"
                                                        {{ in_array($pilier->pilier_id, old('pilier') ?? []) ? 'selected' : '' }}>
                                        ...
                                        <div class="col-md-4">
                                            <label for="typeChoc"> {{ __('Types de chocs') }}
                                            </label>
                                            <select id="typeChoc"
                                                ...
                                                @foreach ($typeChocs as $typeChoc)
                                                    <option value="{{ $typeChoc->typeChoc_id }}"
                                                        {{ in_array($typeChoc->typeChoc_id, old('typeChoc') ?? []) ? 'selected' : '' }}>
                                                        {{ $typeChoc->typeChocLibelle }}</option>
                                                @endforeach
                                            </select>
                                            <div class="invalid-feedback">
                                                {{ __('formulaire.Obligation') }}
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label for="typeReponse"> {{ __('Types de reponse') }}
                                            </label>
                                            <select id="typeReponse"
                                                ...
                                                @foreach ($typeReponses as $typeReponse)
                                                    <option value="{{ $typeReponse->typeReponse_id }}"
                                                        {{ in_array($typeReponse->typeReponse_id, old('typeReponse') ?? []) ? 'selected' : '' }}>
                                            ...
                                            <select id="secteurActivite"
                                                ...
                                                @foreach ($secteurs as $secteurActivite)
                                                    <option value="{{ $secteurActivite->secteurActivite_id }}"
                                                        {{ in_array($secteurActivite->secteurActivite_id, old('secteurActivite') ?? []) ? 'selected' : '' }}>
                                            ...
                                            <select id="partenaire"
                                                ...
                                                @foreach ($partenaires as $partenaire)
                                                    <option value="{{ $partenaire->partenaire_id }}"
                                                        {{ in_array($partenaire->partenaire_id, old('partenaire') ?? []) ? 'selected' : '' }}>
                                            ...
                                            <select id="beneficiaire"
                                                ...
                                                @foreach ($beneficiaires as $beneficiaire)
                                                    <option value="{{ $beneficiaire->beneficiaire_id }}"
                                                        {{ in_array($beneficiaire->beneficiaire_id, old('beneficiaire') ?? []) ? 'selected' : '' }}>
                        ...
                        <div>
                            <fieldset class="mt-3">
                                ...
                                <div id="zones-container">
                                    {{-- <div class="zones-form" id="zones-form"> --}}
                                    @if (!session('zoneActuellesForm'))
                                        <div class="zone-container" id="zone-container0">
                                            <div class="row">
                                                <div class="col-12 col-md-6">
                                                    <label for="pays0"> {{ __('Pays') }} <span
                                                            style="color: red">*</span></label>
                                                    <span title="{{ __('Supprimer') }}"
                                                        class="fa fa-trash text-danger float-right d-md-none removeZone"
                                                        style="cursor: pointer;"></span>
                                                    <select
                                                        class="form-control pays @error('zones.0.pays') is-invalid @enderror"
                                                        name="zones[0][pays]" id="pays0" required>
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <label for="localite1"> {{ __('Localité') }} <span
                                                            style="color: red">*</span></label>
                                                    <span title="{{ __('Supprimer') }}"
                                                        class="fa fa-trash text-danger float-right d-none d-md-inline removeZone"
                                                        style="cursor: pointer;"></span>
                                                    <select id="localite1"
                                                        class="form-control localite @error('zones.0.localite') is-invalid @enderror"
                                                        name="zones[0][localite]" required>
                                                        <option value="" selected disabled>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <label for="latitude1"> {{ __('Latitude') }}</label>
                                                    <input type="text" name="zones[0][latitude]"
                                                        class="form-control coordinates latitude" id="latitude1"
                                                        pattern="^-?([1-8]?\d(\.\d+)?|90(\.0+)?)$"
                                                        placeholder="12.2418505">
                                                </div>
                                                @if ($errors->has('zones.0.latitude'))
                                                    <small class="text-danger">{{ $errors->first('zones.0.longitude') }}
                                                    </small>
                                                @endif
                                                <div class="col-6">
                                                    <label for="longitude1"> {{ __('Longitude') }}</label>
                                                    <input type="text" name="zones[0][longitude]"
                                                        class="form-control coordinates longitude" id="longitude1"
                                                        pattern="^-?((1[0-7]\d|[1-9]?\d)(\.\d+)?|180(\.0+)?)$"
                                                        placeholder="-1.5567604999999958">
                                                </div>
                                                @if ($errors->has('zones.0.longitude'))
                                                    <small class="text-danger">{{ $errors->first('zones.0.Longitude') }}
                                                    </small>
                                                @endif
                                            </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-12 text-right mr-2">
                                        <button title="{{ __('Ajouter') }}" class="btn btn-primary-custom mr-1"
                                            style="border-radius: 50%; width: 40px; height: 40px" type="button"
                                            id="addZone">
                            ...
                            <fieldset class="mt-3">
                                <legend>{{ __('Zones potentielles') }}</legend>
                                <div class="zonesp-container" id="zonesp-container">
                                    @if (!session('zonePotentiellesForm'))
                                        <div class="zonep-container" id="zonep-container0">
                                            <div class="row">
                                                <div class="col-12 col-md-6">
                                                    <label for="paysp0"> {{ __('Pays') }}
                                                        </label>
                                                    <span title="{{ __('Supprimer') }}"
                                                        class="fa fa-trash text-danger float-right d-md-none removeZonep"
                                                        style="cursor: pointer;"></span>
                                                    <select
                                                        class="form-control paysp @error('zonesp.0.pays') is-invalid @enderror"
                                                        name="zonesp[0][pays]" id="paysp0">
                                                        <option value="" selected disabled>
                                                            {{ __('Selectionner le pays') }}</option>
                                                        @foreach ($pays as $item)
                                                            <option value="{{ $item->localite_id }}">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <label for="localitep1"> {{ __('Localité') }}
                                                       </label>
                                                    <span title="{{ __('Supprimer') }}"
                                                        class="fa fa-trash text-danger float-right d-none d-md-inline removeZone"
                                                        style="cursor: pointer;"></span>
                                                    <select id="localitep1"
                                                        class="form-control localitep @error('zonesp.0.localite') is-invalid @enderror"
                                                        name="zonesp[0][localite]">
                                                        <option value="" selected disabled>
                                                            {{ __('Selectionner localité') }}</option>
                                                    </select>
                                                    <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="dropzone d-flex justify-content-center" id="vedetteDropzone">
                                            </div>
                                            @error('image_vedette')
