...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header py-0">{{ __('Ajouter un nouveau thème') }}</div>
                <div class="card-body">
                    <form class="needs-validation" novalidate method="POST" action="{{ route('theme.store') }}">
                        @csrf
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                value="{{ old('themeLibelle') }}" required autofocus onkeyup="this.value = this.value.toUpperCase();">
