    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="needs-validation" novalidate method="POST" action="{{ route('localite.update', $localite->localite_id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="typeLocalite" name="typeLocalite" class="form-control @error('typeLocalite') is-invalid @enderror">
                                    <option value="">{{ __('Sélectionner un type') }}</option>
                                    @foreach($types as $type)
                                        <option value="{{ $type->typeLocalite_id }}" {{ $type->typeLocalite_id == old('typeLocalite', $localite->typeLocalite_id) ? 'selected' : '' }}>
                                            {{ $type->typeLocaliteLibelle }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="localiteNom" value="{{ old('localiteNom', $localite->nomLocalite) }}" required autofocus>
                                <div class="invalid-feedback">
                                    {{ __('formulaire.Obligation') }}
                                </div>
                                @error('localiteNom')
                            ...
                            <div class="col-md-6">
                                <select id="parent" name="parent" class="form-control @error('parent') is-invalid @enderror">
                                    ...
                                    @foreach($localites as $loc)
                                        <option value="{{ $loc->localite_id }}" {{ $loc->localite_id == old('parent', $localite->parent) ? 'selected' : '' }}>
                                            {{ $loc->localiteNom }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="codeAlpha2" value="{{ old('codeAlpha2', $localite->codeAlpha2) }}">
                                <div class="invalid-feedback">
                                    {{ __('formulaire.Obligation') }}
                                </div>
                                @error('codeAlpha2')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="codeAlpha3" value="{{ old('codeAlpha3', $localite->codeAlpha3) }}">
                                <div class="invalid-feedback">
                                    {{ __('formulaire.Obligation') }}
                                </div>
                                @error('codeAlpha3')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="codeNumerique" value="{{ old('codeNumerique', $localite->codeNum) }}">
                                <div class="invalid-feedback">
                                    {{ __('formulaire.Obligation') }}
                                </div>
                                @error('codeNumerique')
