...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header py-0">{{ __('Ajouter bénéficiaire') }}</div>
                <div class="card-body">
                    <form class="needs-validation" novalidate method="POST" action="{{ route('beneficiaire.store') }}">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <select id="typeBeneficiaire" name="typeBeneficiaire" class="form-control @error('typeBeneficiaire') is-invalid @enderror" >
                                    ...
                                    @foreach($types as $type)
                                        <option value="{{ $type->typeBeneficiaire_id }}">{{ $type->typeBeneficiaireLibelle }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="beneficiaireLibelle" value="{{ old('beneficiaireLibelle') }}" required autofocus>
                                <div class="invalid-feedback">
                                    {{ __('formulaire.Obligation') }}
                                </div>
